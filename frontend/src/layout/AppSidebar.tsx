...
const Icon = {
  ...
  Logistics: () => <svg className="w-[18px] h-[18px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}><path strokeLinecap="round" strokeLinejoin="round" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"/></svg>,
  Inspection: () => <svg className="w-[18px] h-[18px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}><path strokeLinecap="round" strokeLinejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" /></svg>,
  ...
  Inventory: () => <svg className="w-[18px] h-[18px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}><path strokeLinecap="round" strokeLinejoin="round" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" /></svg>,
...
const NAV: NavItem[] = [
  ...
  { name: "Inventory",  icon: <Icon.Inventory />,  subItems: [
  ...
  { name: "Inspection",  icon: <Icon.Inspection />, subItems: [
    { name: "Requests",    path: "/inspection/requests" },
    { name: "Checklists",  path: "/inspection/checklists" },
  ]},
  { name: "Logistics",  icon: <Icon.Logistics />, subItems: [
    { name: "Shipments",   path: "/logistics/shipments" },
    { name: "Companies",   path: "/logistics/companies" },
  ]},
